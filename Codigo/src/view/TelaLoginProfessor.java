...
/**
 * UC03 - Tela de Login de Professor
 */
public class TelaLoginProfessor extends JFrame {
    ...
    public TelaLoginProfessor(ControladorProfessor controlador) {
        ...
        // Título
        JLabel lblTitulo = new JLabel("Login Professor", SwingConstants.CENTER);
    ...
    private void autenticar() {
        ...
        Professor professor = controlador.autenticarProf(email, senha);
